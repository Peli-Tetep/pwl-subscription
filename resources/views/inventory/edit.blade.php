        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 text-gray-900">
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                <form action="{{ route('inventory.update', $Inventory->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label class="block font-medium mb-1">Kode Inventory</label>
                        <input type="text" name="kode" value="{{ old('kode', $Inventory->kode) }}" class="w-full border rounded px-3 py-2">
                        @error('kode') <div class="text-red-600 text-sm mt-1">{{ $message }}</div> @enderror
                    </div>

                    <div class="mb-4">
                        <label class="block font-medium mb-1">Nama</label>
                        <input type="text" name="nama" value="{{ old('nama', $Inventory->nama) }}" class="w-full border rounded px-3 py-2">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="number" name="stok" value="{{ old('stok', $Inventory->stok) }}" class="w-full border rounded px-3 py-2">
